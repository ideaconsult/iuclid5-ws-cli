...
public class SessionFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1361698667952L;
    
    private net.idea.i5wscli.query.QueryEngineStub.SessionFault faultMessage;
    ...
    public void setFaultMessage(net.idea.i5wscli.query.QueryEngineStub.SessionFault msg){
       faultMessage = msg;
    }
    
    public net.idea.i5wscli.query.QueryEngineStub.SessionFault getFaultMessage(){
       return faultMessage;
    }
}
