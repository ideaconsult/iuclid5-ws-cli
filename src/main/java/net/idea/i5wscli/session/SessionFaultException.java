...
public class SessionFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1361697361375L;
    
    private net.idea.i5wscli.session.SessionEngineStub.SessionFault faultMessage;
    ...
    public void setFaultMessage(net.idea.i5wscli.session.SessionEngineStub.SessionFault msg){
       faultMessage = msg;
    }
    
    public net.idea.i5wscli.session.SessionEngineStub.SessionFault getFaultMessage(){
       return faultMessage;
    }
}
