...
public class EngineFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1361698125012L;
    
    private net.idea.i5wscli.endpointaccess.EndpointAccessEngineStub.EngineFault faultMessage;
    ...
    public void setFaultMessage(net.idea.i5wscli.endpointaccess.EndpointAccessEngineStub.EngineFault msg){
       faultMessage = msg;
    }
    
    public net.idea.i5wscli.endpointaccess.EndpointAccessEngineStub.EngineFault getFaultMessage(){
       return faultMessage;
    }
}
