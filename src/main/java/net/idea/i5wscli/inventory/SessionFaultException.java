...
public class SessionFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1361698381191L;
    
    private net.idea.i5wscli.inventory.InventoryEngineStub.SessionFault faultMessage;
    ...
    public void setFaultMessage(net.idea.i5wscli.inventory.InventoryEngineStub.SessionFault msg){
       faultMessage = msg;
    }
    
    public net.idea.i5wscli.inventory.InventoryEngineStub.SessionFault getFaultMessage(){
       return faultMessage;
    }
}
