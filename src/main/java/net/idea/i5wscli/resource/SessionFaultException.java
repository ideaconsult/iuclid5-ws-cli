...
public class SessionFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1361698748854L;
    
    private net.idea.i5wscli.resource.ResourceEngineStub.SessionFault faultMessage;
    ...
    public void setFaultMessage(net.idea.i5wscli.resource.ResourceEngineStub.SessionFault msg){
       faultMessage = msg;
    }
    
    public net.idea.i5wscli.resource.ResourceEngineStub.SessionFault getFaultMessage(){
       return faultMessage;
    }
}
