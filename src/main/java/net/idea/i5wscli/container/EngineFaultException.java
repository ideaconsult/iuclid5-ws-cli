...
public class EngineFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1361697817128L;
    
    private net.idea.i5wscli.container.ContainerEngineStub.EngineFault faultMessage;
    ...
    public void setFaultMessage(net.idea.i5wscli.container.ContainerEngineStub.EngineFault msg){
       faultMessage = msg;
    }
    
    public net.idea.i5wscli.container.ContainerEngineStub.EngineFault getFaultMessage(){
       return faultMessage;
    }
}
