...
public class SessionFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1361697992299L;
    
    private net.idea.i5wscli.documentaccess.DocumentAccessEngineStub.SessionFault faultMessage;
    ...
    public void setFaultMessage(net.idea.i5wscli.documentaccess.DocumentAccessEngineStub.SessionFault msg){
       faultMessage = msg;
    }
    
    public net.idea.i5wscli.documentaccess.DocumentAccessEngineStub.SessionFault getFaultMessage(){
       return faultMessage;
    }
}
